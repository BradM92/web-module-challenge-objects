...
function createMenuItem(nameItem, priceItem, categoryItem){
  /*Your code here*/
...
console.log(createMenuItem("burger with bacon", 12, "dinner"));
console.log(createMenuItem("burger with jalapenos", 14, "dinner special"));
...
const burger = {
  ...
  discount(discountApplied){
    if(discountApplied === "teacher" || discountApplied === "student"){
        let discountedPrice = burger.price - 4.5;
        return discountedPrice;
      }
      else if(discountApplied === "public"){
        let discountedPriceReg = burger.price - 1.80;
        return discountedPriceReg;
      }
  },
}
...
function getLastReview(ArrayObj) {
  /*Your code here*/
  let lastReviewSentNum = ArrayObj.length;
  lastReviewSentNum = lastReviewSentNum -1;
  return `${ArrayObj[lastReviewSentNum].name} gave the restaurant a ${ArrayObj[lastReviewSentNum].rating} star review, and their feedback was: ${ArrayObj[lastReviewSentNum].feedback}`
